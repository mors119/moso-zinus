...
<div class="join_agree_wrap">
	...
	<div class="join_term">
		<form action="#" method="post">
			<h3>약관동의</h3>
			<p class="join_all_agree">
				<input type="checkbox" id="allAgree">
				<label for="allAgree">
					<span><strong>지누스의 모든 약관을 확인하고 전체 동의합니다.</strong></span>
					(전체동의, 선택항목도 포함됩니다.)
				</label>
			</p>

			<div class="join_terms_view">
				<p>
					<input type="checkbox" id="termsAgree1" name="">
					<label for="termsAgree1">
						<span><strong>(필수)</strong></span>
						이용약관
					</label>
					<a href="#" target="_blank">전체보기</a>
				</p>
				...
				<div>
					...
					표준약관 제10023호<br>
					<br>
					이 약관은 (주)지누스 회사(전자거래 사업자)가 운영하는 지누스 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
					※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」<br>
					<br>
					<br>
					제2조(정의)<br>
					<br>
					① "몰"이란 (주)지누스 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
					...
					부칙<br>
					<br>
					1. 이 약관은 2018년 11월 26일부터 적용됩니다.<br>
			...
			<div class="join_terms_view">
				<p>
					<input type="checkbox" id="termsAgree2" name="">
				...
				<div>
					...
					<br>
					1. 회원가입<br>
					- 수집항목 : 이름, 아이디, 비밀번호, SNS 계정으로 간편가입 시 (네이버ID : 이름/이메일, 페이스북ID : 이름/프로필)<br>
					- 이용목적 : 회원가입 후 서비스 이용 및 상담, 공지사항 전달<br>
					- 보유 및 이용기간 : 회원탈퇴 요청 5일 후 또는 법정 의무 보유기간<br>
					<br>
					<br>
					2. 주문/결제 <br>
					- 수집항목 : 구매자정보(성명, 휴대폰번호, 이메일), 결제수단에 따라 신용카드정보(카드사명, 카드번호), 계좌정보(은행명, 예금주, 계좌번호), 휴대폰정보(통신사, 휴대폰번호), 상품 구매/취소/반품/교환/환불 정보<br>
					- 이용목적 : 본인확인, 주문 상품의 결제 및 환불<br>
					- 보유 및 이용기간 : 회원탈퇴 요청 5일 후 또는 법정 의무 보유기간<br>
					<br>
					3. 배송<br>
					- 수집항목 : 수령인 정보(성명, 주소, 휴대폰번호, 전화번호)<br>
					- 이용목적 : 주문상품의 배송<br>
					- 보유 및 이용기간 : 회원탈퇴 요청 5일 후 또는 법정 의무 보유기간<br>
					<br>
					4. 상담 및 고객 고충처리<br>
					- 항목 : 아이디, 이메일, 휴대전화번호<br>
					- 보유 및 이용기간 : 회원탈퇴 요청 5일 후 또는 법정 의무 보유기간<br>
					<br>
					5. 서비스 개선을 위한 통계 분석<br>
					- 항목 : 쿠키, 서비스 이용 기록(최근 접속일, 접속 IP 정보, 구매로그, 이벤트 로그), 기기정보(고유 기기 식별값, OS버전)<br>
					- 보유 및 이용기간 : 회원탈퇴 요청 5일 후 또는 법정 의무 보유기간<br>
					<br>
					<br>
					[개인정보 제3자 제공에 대한 동의]<br>
					<br>
					1. 제공받는자 : 경동화물/대신택배/로젠택배<br>
					2. 제공항목 : 성명, 전화번호, 휴대폰번호, 상품 구매정보, 배송정보<br>
					3. 이용목적 : 주문확인 및 배송, 교환/반품 처리<br>
					- 보유 및 이용기간 : 회원탈퇴 요청 5일 후 또는 법정 의무 보유기간<br>
					<br>
					귀하는 개인정보 제공 등에 관해 동의하지 않을 권리가 있습니다. 다만, 필수수집 동의를 하지 않을 경우 상품 구입이 불가합니다.<br>
					더 자세한 내용에 대해서는 개인정보취급방침을 참고하시기 바랍니다.
				</div>
			</div>
			...
			<div class="join_terms_view">
				<p>
					...
					<label for="termsAgree3">
						<span class="option"><strong>(선택)</strong></span>
						개인정보 수집 및 이용
					</label>
					<a href="#" target="_blank">전체보기</a>
				</p>
					...
					<table>
						...
						<tbody>
							<tr>
								<td>
									<div>
										지누스에서 제공하는 이벤트 및 혜택 등 다양한 정보를 문자메시지, 이메일 등으로 받아보실 수 있습니다. 마케팅 정보 수신 및 활용 동의 여부와 관계없이 회원가입 및 서비스를 이용하실 수 있습니다. 또한 서비스의 중요 안내사항 및 주문/배송에 대한 정보는 마케팅 정보 수신 동의 여부와 관계없이 발송됩니다.<br>
										<br>
										1. 수집·이용목적<br>
										마케팅 및 분석<br>
										프로모션<br>
										<br>
										2. 수집·이용항목<br>
										회원 정보(이름, 휴대폰 번호, 이메일, 성별, 생년월일, 회원등급, 가입일시)<br>
										쇼핑 및 서비스 이용 정보(장바구니의 상품, 구매일시, 배송지역)<br>
										수집∙이용항목은 마케팅 및 분석, 프로모션의 목적에 따라 달라질 수 있으며 수집 시점에 안내 후 동의여부를 별도 확인함<br>
										<br>
										3. 보유 및 이용기간<br>
										정보 삭제 또는 이용 정지 요청 및 회원탈퇴 시 즉시 삭제<br>
										<br>
										4. 마케팅 활용 정보 수집 방법<br>
										희망자에 한해 직접 입력
									</div>
								</td>
							</tr>
			...
			<p class="join_msg">
				<span>(필수)이용약관을 체크해주세요.</span>
			</p>

			<div class="join_btns">
				<button id="btnPrevStep" type="button">이전단계</button>
